function level_Impulse_con_mod(mod,irfsimnum)
  ...
  % for i=1:3 %% Loop over models
        ...
        for k=1:temp_irf
           ...
           if k==3
            ...
            if k==temp_irf+1, xlabel('Quarters'); end
           ...
           if k==3
                    plot(1:irf_sim,[eval(strcat(['dyn_irfp_',shocks{j},'_raw_lev(dyn_i_Ic,1:irf_sim)']))],style,'LineWidth',2);  
...
%             end
    ...
    fname=strcat([num2str(mod),'_',shocks{j},'_',num2str(irf_sim),'_con']);    
