function F = myfun2(x, mu, rho, beta, psi, gamma, Lss, alphac, alphap, deltak, deltac, xi, tau, arc, w, Gprimss, Gss, philev, rhoar, phi_growth)
...
(x(16) - (x(26)/(1-Gprimss)));
(exp(x(17)) - (((1-1/tau)*x(25)*alphap*exp(x(6) - x(8)+x(3))+ (-(1-alphap)*(1/tau)*x(25)*(1-rhoar)*phi_growth*exp(x(6) - x(8)+x(3)))+ (x(25)*(1-alphap)*phi_growth*exp(x(6) - x(8)+x(3))) +x(16)*(1-deltak)+x(16)*(Gprimss*exp(x(10)-x(9)+x(3))-Gss))/x(16)));
(1-( exp(x(14) + x(17))));
(exp(x(23))-(alphac*exp(x(7)-x(9)+x(3))+(-(1-alphac)*rhoar*phi_growth*exp(x(7)-x(9)+x(3)))+x(16)*(1-deltac))/x(16));
(1-( exp(x(14) + x(23))));
