function F = myfun3(x, beta, psi, Lss, alphac, alphap, deltak, deltac, tau, arc, w, Abar, ome_p_bar, xi_p, nu, eta, chi, phi_p)
...
(1-  beta*exp(-x(4)/psi)*(alphac*exp((log(Abar)+(1-alphap)*(ome_p_bar)+alphac*(x(2))+ (1-alphac)*(log(1-Lss)+arc))-x(2))+x(5)*(1-deltac))/x(5));
...
%1 kss 2 kcss 3 sss 4 dass 5 ptilss
