function compare_mod_single(mod1,mod2,varargin)
...
%             end;
        ...
        fname=strcat([num2str(mod1),'_vs_',num2str(mod2),'_',shocks{1},'_',shocks{2},'_irf_singleshock', num2str(j)]);    
