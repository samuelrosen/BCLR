function level_Impulse_compare_data3(mod1)
...
% for j=1:3 %% Loop over lists within irf_vars
  ...
  % for i=1:3 %% Loop over models
        ...
        if i==1
            ...
            load(strcat('Compare Mod\VAR\Model VAR\Matlab\Model_',num2str(mod1),'_VARdata.mat'));
            style='-k';
        elseif i==2    
            load(strcat('Compare Mod\VAR\Model VAR\Matlab\Model_',num2str(mod1),'_VARdata.mat'));
            style='-b';
    ...
    fname=strcat([num2str(mod1),'VAR_vs_Data_VAR_',shocks{j},'_',num2str(irf_sim),'Matlab']);    
